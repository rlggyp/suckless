...
static const char *fonts[]          = { "DroidSansMono NF:size=10" };
static const char dmenufont[]       = "DroidSansMono NF:size=10";
static const char col_1[]       = "#282828";
static const char col_2[]       = "#ebdbb2";
static const char col_3[]        = "#4d656f";
...
static const char *dmenucmd[] = { "dmenu_run", "-p", "Run: ", "-m", dmenumon, "-fn", dmenufont, "-nb", col_1, "-nf", col_2, "-sb", col_3, "-sf", col_2, NULL };
