...
static Key keys[] = {
	...
	{ 0,														XK_Print,	                			spawn,					SHCMD("flameshot full -p ~/Pictures/")},
	{ MODKEY,												XK_Print,	              			  spawn,					SHCMD("flameshot gui -p ~/Pictures/")},
	{ MODKEY|ShiftMask,							XK_Print,				                spawn,					SHCMD("flameshot full -p .scrot.png && xclip -selection c -t image/png -i .scrot.png && rm .scrot.png")},
	{ MODKEY|ControlMask,						XK_Print,	 				              spawn,					SHCMD("flameshot gui -p .scrot.png && xclip -selection c -t image/png -i .scrot.png && rm .scrot.png")},
